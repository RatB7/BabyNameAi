      ...
      <div className="fixed inset-0 z-50 flex items-center justify-center p-4 sm:p-6 md:p-8">
        ...
        >
          ...
          <div className="flex items-center justify-between px-6 py-5 border-b border-slate-100 bg-slate-50/80">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-slate-500 font-medium">Official policies and privacy controls for BabyName AI</p>
              </div>
            </div>
            ...
            {activeTab === "privacy" && (
              <div className="space-y-6 animate-fade-in">
                <div className="bg-indigo-50/60 border border-indigo-100 rounded-2xl p-4 flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-slate-600 mt-0.5">
                      Last updated: July 2026. BabyName AI is committed to protecting your family's personal privacy and preserving transparent data handling practices.
                    </p>
                  </div>
                </div>
                ...
                <section className="space-y-2">
                  ...
                  <p>
                    BabyName AI utilizes Google Search API grounding and Gemini LLM services to verify historical etymologies and real-time popularity charts. Information transmitted to AI models is anonymized and stripped of personal identifiers.
                  </p>
                </section>
              ...
              <div className="space-y-6 animate-fade-in">
                <div className="bg-slate-100 rounded-2xl p-4 flex items-start gap-3 border border-slate-200">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-slate-600 mt-0.5">
                      Effective Date: July 2026. By accessing or using BabyName AI, you agree to be bound by these Terms of Service.
                    </p>
                  </div>
                </div>
                ...
                <section className="space-y-2">
                  ...
                  <p>
                    Name meanings, pronunciations, numerology scores, and historical origins generated by BabyName AI are provided for educational, cultural, and inspirational purposes only. While our algorithms cross-reference validated dictionaries and search data, cultural interpretations may vary across regions and families.
                  </p>
                </section>
                ...
                <section className="space-y-2">
                  ...
                  <p>
                    All branding, UI design, custom graphics, and software code are the exclusive property of BabyName AI. You retain full ownership of any custom lists or notes created using our platform for personal, non-commercial use.
                  </p>
                </section>
          ...
          <div className="px-6 py-4 border-t border-slate-100 bg-slate-50/80 flex items-center justify-between text-xs text-slate-500">
            <span>© {new Date().getFullYear()} BabyName AI Regulatory Suite</span>
            <button
              onClick={onClose}
